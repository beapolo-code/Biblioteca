import { An as forwardRef, L as EventEmitter, Ri as signal, W as InjectionToken, aa as ɵɵdefineInjector, fa as ɵɵnamespaceSVG, tt as NgZone, ua as ɵɵnamespaceHTML, yr as inject } from "./_resource-chunk-Bs197SVl.js";
import { $a as ɵɵdomProperty, Ba as ɵɵdefineComponent, Fo as ɵɵloadQuery, Go as ɵɵproperty, Ha as ɵɵdefineNgModule, Ji as ɵɵNgOnChangesFeature, Jt as Component, Ks as ɵɵviewQuery, Nn as NgModule, O as booleanAttribute, Po as ɵɵlistener, S as ViewChild, Sn as Input, Uo as ɵɵprojection, Wo as ɵɵprojectionDef, Xi as ɵɵadvance, Yi as ɵɵProvidersFeature, aa as ɵɵclassMap, ao as ɵɵelementEnd, as as ɵɵreference, f as HostAttributeToken, fn as ElementRef, ia as ɵɵattribute, ki as setClassMetadata, oa as ɵɵclassProp, oo as ɵɵelementStart, pr as ViewEncapsulation, r as ChangeDetectorRef, rs as ɵɵqueryRefresh, rt as numberAttribute, to as ɵɵelement, zn as Output } from "./core-7astvhVk.js";
...
var MatCheckbox = class MatCheckbox {
	...
	ngOnChanges(changes) {
		if (changes["required"]) this._validatorChangeFn();
	}
	ngAfterViewInit() {
	...
	set indeterminate(value) {
		...
		if (changed) {
			if (value) this._transitionCheckState(TransitionCheckState.Indeterminate);
			else this._transitionCheckState(this.checked ? TransitionCheckState.Checked : TransitionCheckState.Unchecked);
	...
	_transitionCheckState(newState) {
		...
		if (oldState === newState || !element) return;
		if (this._currentAnimationClass) element.classList.remove(this._currentAnimationClass);
	...
	_emitChangeEvent() {
		...
		if (this._inputElement) this._inputElement.nativeElement.checked = this.checked;
	}
	toggle() {
	...
	_handleInputClick() {
		...
		if (!this.disabled && clickAction !== "noop") {
			if (this.indeterminate && clickAction !== "check") Promise.resolve().then(() => {
	...
	_getAnimationClassForCheckStateTransition(oldState, newState) {
		if (this._animationsDisabled) return "";
		switch (oldState) {
			case TransitionCheckState.Init:
				if (newState === TransitionCheckState.Checked) return this._animationClasses.uncheckedToChecked;
				else if (newState == TransitionCheckState.Indeterminate) return this._checked ? this._animationClasses.checkedToIndeterminate : this._animationClasses.uncheckedToIndeterminate;
				break;
			case TransitionCheckState.Unchecked: return newState === TransitionCheckState.Checked ? this._animationClasses.uncheckedToChecked : this._animationClasses.uncheckedToIndeterminate;
			case TransitionCheckState.Checked: return newState === TransitionCheckState.Unchecked ? this._animationClasses.checkedToUnchecked : this._animationClasses.checkedToIndeterminate;
			case TransitionCheckState.Indeterminate: return newState === TransitionCheckState.Checked ? this._animationClasses.indeterminateToChecked : this._animationClasses.indeterminateToUnchecked;
		}
		return "";
	}
	_syncIndeterminate(value) {
		const nativeCheckbox = this._inputElement;
		if (nativeCheckbox) nativeCheckbox.nativeElement.indeterminate = value;
	}
	_onInputClick() {
		this._handleInputClick();
	}
	_preventBubblingFromLabel(event) {
		if (event.target && this._inputElement && event.target !== this._inputElement.nativeElement) event.stopPropagation();
	}
	...
	static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
		...
		inputs: {
			...
			tabIndex: [
				...
				"tabIndex",
				"tabIndex",
				(value) => value == null ? void 0 : numberAttribute(value)
			],
			color: "color",
			disabledInteractive: [
				2,
...
var MatCheckboxModule = class MatCheckboxModule {
	...
	static ɵinj = /* @__PURE__ */ ɵɵdefineInjector({ imports: [MatCheckbox, BidiModule] });
};
(() => {
