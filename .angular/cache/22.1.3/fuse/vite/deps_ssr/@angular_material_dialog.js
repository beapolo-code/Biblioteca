import { E as DOCUMENT, G as Injector, L as EventEmitter, Ri as signal, W as InjectionToken, aa as ɵɵdefineInjector, tt as NgZone, v as require_operators, yr as inject } from "./_resource-chunk-Bs197SVl.js";
import { $a as ɵɵdomProperty, Ba as ɵɵdefineComponent, Ds as ɵɵtemplate, Fo as ɵɵloadQuery, Gt as ChangeDetectionStrategy, Ha as ɵɵdefineNgModule, Ji as ɵɵNgOnChangesFeature, Jt as Component, Ki as ɵɵHostDirectivesFeature, Ks as ɵɵviewQuery, Nn as NgModule, Po as ɵɵlistener, S as ViewChild, Sn as Input, Va as ɵɵdefineDirective, Wa as ɵɵdefineService, Wn as Renderer2, Zn as Service, ao as ɵɵelementEnd, fn as ElementRef, ia as ɵɵattribute, ir as TemplateRef, ki as setClassMetadata, oa as ɵɵclassProp, oo as ɵɵelementStart, po as ɵɵgetInheritedFactory, pr as ViewEncapsulation, qi as ɵɵInheritDefinitionFeature, r as ChangeDetectorRef, rs as ɵɵqueryRefresh, un as Directive, vr as afterNextRender } from "./core-7astvhVk.js";
...
import { C as InteractivityChecker, M as FocusMonitor, b as FocusTrapFactory, g as A11yModule } from "./a11y-2dXFx_gi.js";
import { r as coerceNumberProperty } from "./_element-chunk-Dra2rBy8.js";
...
import { r as CdkScrollable } from "./scrolling-CdrI-2b0.js";
import { E as createBlockScrollStrategy, _ as OverlayModule, b as OverlayRef, h as OverlayContainer, j as createOverlayRef, k as createGlobalPositionStrategy, m as OverlayConfig } from "./overlay-C5l9NVxv.js";
import { i as ComponentPortal, o as PortalModule, r as CdkPortalOutlet, s as TemplatePortal, t as BasePortalOutlet } from "./portal-DmyotqXb.js";
...
var CdkDialogContainer = class CdkDialogContainer extends BasePortalOutlet {
	...
	_portalOutlet;
	_focusTrapped = new import_cjs.Subject();
	_focusTrap = null;
...
var Dialog = class Dialog {
	...
	_afterAllClosedAtThisLevel = new import_cjs.Subject();
	_afterOpenedAtThisLevel = new import_cjs.Subject();
	...
	afterAllClosed = (0, import_cjs.defer)(() => this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe((0, import_operators.startWith)(void 0)));
	open(componentOrTemplateRef, config) {
		...
		if (!this.openDialogs.length) {
			...
			if (dialogContainer._focusTrapped) dialogContainer._focusTrapped.pipe((0, import_operators.take)(1)).subscribe(() => {
...
var MatDialogRef = class {
	...
	disableClose;
	id;
	_afterOpened = new import_cjs.ReplaySubject(1);
	_beforeClosed = new import_cjs.ReplaySubject(1);
	_result;
	...
	constructor(_ref, _config, _containerInstance) {
		...
		(0, import_cjs.merge)(this.backdropClick(), this.keydownEvents().pipe((0, import_operators.filter)((event) => event.keyCode === 27 && !this.disableClose && !hasModifierKey(event)))).subscribe((event) => {
