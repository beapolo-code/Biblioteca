import { L as EventEmitter, Ri as signal, W as InjectionToken, aa as ɵɵdefineInjector, fa as ɵɵnamespaceSVG, yr as inject } from "./_resource-chunk-Bs197SVl.js";
import { Ba as ɵɵdefineComponent, Ga as ɵɵdirectiveInject, Ha as ɵɵdefineNgModule, Ji as ɵɵNgOnChangesFeature, Jt as Component, Ka as ɵɵdomElement, Nn as NgModule, O as booleanAttribute, Po as ɵɵlistener, Rn as Optional, Sn as Input, Uo as ɵɵprojection, Va as ɵɵdefineDirective, Wa as ɵɵdefineService, Wo as ɵɵprojectionDef, Xa as ɵɵdomElementEnd, Xi as ɵɵadvance, Za as ɵɵdomElementStart, Zn as Service, bn as Inject, ca as ɵɵconditional, fn as ElementRef, ia as ɵɵattribute, ki as setClassMetadata, oa as ɵɵclassProp, pr as ViewEncapsulation, r as ChangeDetectorRef, ua as ɵɵconditionalCreate, un as Directive, zn as Output } from "./core-7astvhVk.js";
import { t as require_cjs } from "./rxjs.js";
import { M as FocusMonitor, t as AriaDescriber } from "./a11y-2dXFx_gi.js";
...
import { a as CdkColumnDef } from "./table-BcbQ3lR-.js";
...
var MatSort = class MatSort {
	_defaultOptions;
	_initializedStream = new import_cjs.ReplaySubject(1);
	...
	static ɵfac = function MatSort_Factory(__ngFactoryType__) {
		return new (__ngFactoryType__ || MatSort)(ɵɵdirectiveInject(MAT_SORT_DEFAULT_OPTIONS, 8));
	};
...
var MatSortHeader = class MatSortHeader {
	_sort = inject(MatSort, { optional: true });
	_columnDef = inject(CdkColumnDef, { optional: true });
	...
	constructor() {
		...
		if (defaultOptions?.arrowPosition) this.arrowPosition = defaultOptions?.arrowPosition;
	}
	ngOnInit() {
		if (!this.id && this._columnDef) this.id = this._columnDef.name;
		this._sort.register(this);
		this._renderChanges = (0, import_cjs.merge)(this._sort._stateChanges, this._sort.sortChange).subscribe(() => this._changeDetectorRef.markForCheck());
	...
	ngOnDestroy() {
		...
		if (this._sortButton) this._ariaDescriber?.removeDescription(this._sortButton, this._sortActionDescription);
	}
...
var MatSortModule = class MatSortModule {
...
var MatSortHeaderIntl = class MatSortHeaderIntl {
