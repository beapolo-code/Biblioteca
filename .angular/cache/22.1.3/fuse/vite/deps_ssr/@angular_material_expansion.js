import { E as DOCUMENT, L as EventEmitter, Ri as signal, W as InjectionToken, aa as ɵɵdefineInjector, fa as ɵɵnamespaceSVG, tt as NgZone, v as require_operators, yr as inject } from "./_resource-chunk-Bs197SVl.js";
import { Ba as ɵɵdefineComponent, Ds as ɵɵtemplate, Fo as ɵɵloadQuery, Go as ɵɵproperty, Ha as ɵɵdefineNgModule, Hn as QueryList, Ji as ɵɵNgOnChangesFeature, Jt as Component, Ka as ɵɵdomElement, Ks as ɵɵviewQuery, Nn as NgModule, O as booleanAttribute, Po as ɵɵlistener, S as ViewChild, Sn as Input, Uo as ɵɵprojection, Va as ɵɵdefineDirective, Wn as Renderer2, Wo as ɵɵprojectionDef, Xa as ɵɵdomElementEnd, Xi as ɵɵadvance, Yi as ɵɵProvidersFeature, Za as ɵɵdomElementStart, a as ContentChildren, ao as ɵɵelementEnd, ca as ɵɵconditional, da as ɵɵcontentQuery, f as HostAttributeToken, fn as ElementRef, fr as ViewContainerRef, i as ContentChild, ia as ɵɵattribute, ir as TemplateRef, ki as setClassMetadata, oa as ɵɵclassProp, oo as ɵɵelementStart, po as ɵɵgetInheritedFactory, pr as ViewEncapsulation, qi as ɵɵInheritDefinitionFeature, r as ChangeDetectorRef, rs as ɵɵqueryRefresh, rt as numberAttribute, ua as ɵɵconditionalCreate, un as Directive, ws as ɵɵstyleProp, zn as Output } from "./core-7astvhVk.js";
...
import { o as PortalModule, r as CdkPortalOutlet, s as TemplatePortal } from "./portal-DmyotqXb.js";
...
import { t as UniqueSelectionDispatcher } from "./_unique-selection-dispatcher-chunk-Df9YK-oP.js";
...
var CdkAccordion = class CdkAccordion {
	...
	_openCloseAllActions = new import_cjs.Subject();
...
var CdkAccordionItem = class CdkAccordionItem {
	...
	_openCloseAllSubscription = import_cjs.Subscription.EMPTY;
...
var MatExpansionPanel = class MatExpansionPanel extends CdkAccordionItem {
	...
	_inputChanges = new import_cjs.Subject();
	...
	ngAfterContentInit() {
		if (this._lazyContent && this._lazyContent._expansionPanel === this) this.opened.pipe((0, import_operators.startWith)(null), (0, import_operators.filter)(() => this.expanded && !this._portal), (0, import_operators.take)(1)).subscribe(() => {
...
var MatExpansionPanelHeader = class MatExpansionPanelHeader {
	...
	_changeDetectorRef = inject(ChangeDetectorRef);
	_parentChangeSubscription = import_cjs.Subscription.EMPTY;
	constructor() {
		inject(_CdkPrivateStyleLoader).load(_StructuralStylesLoader);
		const panel = this.panel;
		const defaultOptions = inject(MAT_EXPANSION_PANEL_DEFAULT_OPTIONS, { optional: true });
		const tabIndex = inject(new HostAttributeToken("tabindex"), { optional: true });
		const accordionHideToggleChange = panel.accordion ? panel.accordion._stateChanges.pipe((0, import_operators.filter)((changes) => !!(changes["hideToggle"] || changes["togglePosition"]))) : import_cjs.EMPTY;
		this.tabIndex = parseInt(tabIndex || "") || 0;
		this._parentChangeSubscription = (0, import_cjs.merge)(panel.opened, panel.closed, accordionHideToggleChange, panel._inputChanges.pipe((0, import_operators.filter)((changes) => {
