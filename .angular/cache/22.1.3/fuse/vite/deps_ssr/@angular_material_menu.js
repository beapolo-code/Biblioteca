import { E as DOCUMENT, G as Injector, L as EventEmitter, Ri as signal, W as InjectionToken, aa as ɵɵdefineInjector, fa as ɵɵnamespaceSVG, ma as ɵɵrestoreView, pa as ɵɵresetView, tt as NgZone, v as require_operators, yr as inject } from "./_resource-chunk-Bs197SVl.js";
import { $a as ɵɵdomProperty, Ba as ɵɵdefineComponent, Fo as ɵɵloadQuery, Go as ɵɵproperty, Ha as ɵɵdefineNgModule, Hn as QueryList, Io as ɵɵnextContext, Jt as Component, Ks as ɵɵviewQuery, Nn as NgModule, No as ɵɵinvalidFactory, O as booleanAttribute, Po as ɵɵlistener, Qa as ɵɵdomListener, S as ViewChild, Sn as Input, Uo as ɵɵprojection, Va as ɵɵdefineDirective, Vt as ApplicationRef, Wn as Renderer2, Wo as ɵɵprojectionDef, Xa as ɵɵdomElementEnd, Xi as ɵɵadvance, Yi as ɵɵProvidersFeature, Za as ɵɵdomElementStart, a as ContentChildren, aa as ɵɵclassMap, ao as ɵɵelementEnd, ca as ɵɵconditional, da as ɵɵcontentQuery, eo as ɵɵdomTemplate, fn as ElementRef, fo as ɵɵgetCurrentView, fr as ViewContainerRef, i as ContentChild, ia as ɵɵattribute, ir as TemplateRef, ki as setClassMetadata, oa as ɵɵclassProp, oo as ɵɵelementStart, pr as ViewEncapsulation, qi as ɵɵInheritDefinitionFeature, r as ChangeDetectorRef, rs as ɵɵqueryRefresh, to as ɵɵelement, ua as ɵɵconditionalCreate, un as Directive, vr as afterNextRender, zn as Output } from "./core-7astvhVk.js";
import { t as require_cjs } from "./rxjs.js";
import { n as isFakeTouchstartFromScreenReader, t as isFakeMousedownFromScreenReader } from "./_fake-event-detection-chunk-DX8QaHBm.js";
import { i as _getShadowRoot, n as _getEventTarget, t as _IdGenerator } from "./_id-generator-chunk-CegWFmGw.js";
import { M as FocusMonitor, p as FocusKeyManager } from "./a11y-2dXFx_gi.js";
...
import { d as ViewportRuler, i as CdkScrollableModule, l as ScrollDispatcher } from "./scrolling-CdrI-2b0.js";
import { M as createRepositionScrollStrategy, O as createFlexibleConnectedPositionStrategy, _ as OverlayModule, j as createOverlayRef, m as OverlayConfig } from "./overlay-C5l9NVxv.js";
import { a as DomPortalOutlet, s as TemplatePortal } from "./portal-DmyotqXb.js";
import { n as _animationsDisabled } from "./_animation-chunk-yxJd56ox.js";
import "./platform-CJtxtLVu.js";
import { n as MatRipple } from "./_ripple-chunk-BoIgpYer.js";
import { t as _StructuralStylesLoader } from "./_structural-styles-chunk-dG2Ns2QL.js";
import { t as MatRippleModule } from "./_ripple-module-chunk-95VmbPBD.js";
...
var MatMenuItem = class MatMenuItem {
	...
	disabled = false;
	disableRipple = false;
	_hovered = new import_cjs.Subject();
	_focused = new import_cjs.Subject();
	_highlighted = false;
...
var MatMenuContent = class MatMenuContent {
	...
	_portal;
	_outlet;
	_attached = new import_cjs.Subject();
	attach(context = {}) {
...
var MatMenu = class MatMenu {
	...
	ngAfterContentInit() {
		...
		this._directDescendantItems.changes.pipe((0, import_operators.startWith)(this._directDescendantItems), (0, import_operators.switchMap)((items) => (0, import_cjs.merge)(...items.map((item) => item._focused)))).subscribe((focusedItem) => this._keyManager.updateActiveItem(focusedItem));
	...
	_hovered() {
		return this._directDescendantItems.changes.pipe((0, import_operators.startWith)(this._directDescendantItems), (0, import_operators.switchMap)((items) => (0, import_cjs.merge)(...items.map((item) => item._hovered))));
	}
	addItem(_item) {}
	removeItem(_item) {}
...
var MatMenuTriggerBase = class MatMenuTriggerBase {
	_canHaveBackdrop;
	...
	_overlayRef = null;
	_menuOpen = false;
	_closingActionsSubscription = import_cjs.Subscription.EMPTY;
	_menuCloseSubscription = import_cjs.Subscription.EMPTY;
	_pendingRemoval;
	_parentMaterialMenu;
	_parentInnerPadding;
	_openedBy = void 0;
	...
	_openMenu(autoFocus) {
		...
		else overlayConfig.hasBackdrop = menu.hasBackdrop ?? false;
	...
	_destroyMenu(reason) {
		...
		if (menu instanceof MatMenu && this._ownsMenu(menu)) {
			this._pendingRemoval = menu._animationDone.pipe((0, import_operators.take)(1)).subscribe(() => {
				overlayRef.detach();
				if (!PANELS_TO_TRIGGERS.has(menu)) menu.lazyContent?.detach();
			});
	...
	_menuClosingActions() {
		...
		return (0, import_cjs.merge)(outsideClicks, this._parentMaterialMenu ? this._parentMaterialMenu.closed : (0, import_cjs.of)(), this._parentMaterialMenu ? this._parentMaterialMenu._hovered().pipe((0, import_operators.filter)((active) => this._menuOpen && active !== this._menuItemInstance)) : (0, import_cjs.of)(), detachments);
	}
	_getPortal(menu) {
	...
	static ɵdir = /* @__PURE__ */ ɵɵdefineDirective({ type: MatMenuTriggerBase });
};
(() => {
	(typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MatMenuTriggerBase, [{ type: Directive }], () => [{ type: void 0 }], null);
})();
var MatMenuTrigger = class MatMenuTrigger extends MatMenuTriggerBase {
	_cleanupTouchstart;
	_hoverSubscription = import_cjs.Subscription.EMPTY;
	...
	static ɵdir = /* @__PURE__ */ ɵɵdefineDirective({
		...
		hostBindings: function MatMenuTrigger_HostBindings(rf, ctx) {
			...
			if (rf & 2) ɵɵattribute("aria-haspopup", ctx.menu ? "menu" : null)("aria-expanded", ctx.menuOpen)("aria-controls", ctx.menuOpen ? ctx.menu?.panelId : null);
		},
		inputs: {
...
var MatContextMenuTrigger = class MatContextMenuTrigger extends MatMenuTriggerBase {
	_point = {
		x: 0,
		y: 0,
		initialX: 0,
	...
	_getOutsideClickStream(overlayRef) {
		return overlayRef.outsidePointerEvents().pipe((0, import_operators.skipWhile)((event, index) => {
...
var MatMenuModule = class MatMenuModule {
