import { G as Injector, L as EventEmitter, Ri as signal, W as InjectionToken, aa as ɵɵdefineInjector, fa as ɵɵnamespaceSVG, ma as ɵɵrestoreView, pa as ɵɵresetView, v as require_operators, yr as inject } from "./_resource-chunk-Bs197SVl.js";
import { As as ɵɵtextInterpolate, Ba as ɵɵdefineComponent, Ds as ɵɵtemplate, Fo as ɵɵloadQuery, Go as ɵɵproperty, Ha as ɵɵdefineNgModule, Io as ɵɵnextContext, Ji as ɵɵNgOnChangesFeature, Jt as Component, Ks as ɵɵviewQuery, Nn as NgModule, O as booleanAttribute, Po as ɵɵlistener, S as ViewChild, Sn as Input, Uo as ɵɵprojection, Va as ɵɵdefineDirective, Wn as Renderer2, Wo as ɵɵprojectionDef, Xi as ɵɵadvance, Yi as ɵɵProvidersFeature, a as ContentChildren, aa as ɵɵclassMap, ao as ɵɵelementEnd, as as ɵɵreference, ca as ɵɵconditional, da as ɵɵcontentQuery, f as HostAttributeToken, fn as ElementRef, fo as ɵɵgetCurrentView, i as ContentChild, ia as ɵɵattribute, ki as setClassMetadata, ks as ɵɵtext, oa as ɵɵclassProp, oo as ɵɵelementStart, pr as ViewEncapsulation, r as ChangeDetectorRef, rs as ɵɵqueryRefresh, rt as numberAttribute, to as ɵɵelement, ua as ɵɵconditionalCreate, un as Directive, zn as Output } from "./core-7astvhVk.js";
import { t as require_cjs } from "./rxjs.js";
import { n as _getEventTarget, t as _IdGenerator } from "./_id-generator-chunk-CegWFmGw.js";
import { D as LiveAnnouncer, m as ActiveDescendantKeyManager } from "./a11y-2dXFx_gi.js";
...
import { d as ViewportRuler, i as CdkScrollableModule } from "./scrolling-CdrI-2b0.js";
import { M as createRepositionScrollStrategy, _ as OverlayModule, a as CdkOverlayOrigin, f as OVERLAY_DEFAULT_CONFIG, i as CdkConnectedOverlay } from "./overlay-C5l9NVxv.js";
...
import { i as MatOption, n as MAT_OPTION_PARENT_COMPONENT, o as _countGroupLabelsBeforeOption, r as MatOptgroup, s as _getOptionScrollPosition, t as MAT_OPTGROUP } from "./_option-chunk-BTvQ8qHz.js";
import { t as MatOptionModule } from "./_option-module-chunk-B8PcYNJj.js";
import "./observers-private-DK_CCqui.js";
import { c as MatFormFieldControl, d as MatPrefix, f as MatSuffix, l as MatHint, n as MAT_FORM_FIELD, o as MatError, s as MatFormField, u as MatLabel } from "./_form-field-chunk-BdH_Exe6.js";
import { t as SelectionModel } from "./_selection-model-chunk-DAywg8vD.js";
...
var MatSelect = class MatSelect {
	...
	_popoverLocation;
	_initialized = new import_cjs.Subject();
	_cleanupDetach;
	options;
	optionGroups;
	customTrigger;
	...
	_previousControl;
	_destroy = new import_cjs.Subject();
	_errorStateTracker;
	...
	optionSelectionChanges = (0, import_cjs.defer)(() => {
		const options = this.options;
		if (options) return options.changes.pipe((0, import_operators.startWith)(options), (0, import_operators.switchMap)(() => (0, import_cjs.merge)(...options.map((option) => option.onSelectionChange))));
	...
	_resetOptions() {
		const changedOrDestroyed = (0, import_cjs.merge)(this.options.changes, this._destroy);
		...
		(0, import_cjs.merge)(...this.options.map((option) => option._stateChanges)).pipe((0, import_operators.takeUntil)(changedOrDestroyed)).subscribe(() => {
			this._changeDetectorRef.detectChanges();
			this.stateChanges.next();
		});
	}
