import { An as forwardRef, F as EnvironmentInjector, G as Injector, L as EventEmitter, W as InjectionToken, aa as ɵɵdefineInjector, tt as NgZone, v as require_operators, yr as inject } from "./_resource-chunk-Bs197SVl.js";
...
import { t as BreakpointObserver } from "./_breakpoints-observer-chunk-BIvIL4Yo.js";
...
import { a as MatOptionSelectionChange, i as MatOption, n as MAT_OPTION_PARENT_COMPONENT, o as _countGroupLabelsBeforeOption, r as MatOptgroup, s as _getOptionScrollPosition, t as MAT_OPTGROUP } from "./_option-chunk-BTvQ8qHz.js";
...
var MatAutocomplete = class MatAutocomplete {
	...
	_activeOptionChanges = import_cjs.Subscription.EMPTY;
	_keyManager;
	showPanel = false;
	get isOpen() {
...
var MatAutocompleteTrigger = class MatAutocompleteTrigger {
	...
	_viewportSubscription = import_cjs.Subscription.EMPTY;
	_breakpointObserver = inject(BreakpointObserver);
	_handsetLandscapeSubscription = import_cjs.Subscription.EMPTY;
	_canOpenOnNextFocus = true;
	_valueBeforeAutoSelection;
	_pendingAutoselectedOption = null;
	_closeKeyEventStream = new import_cjs.Subject();
	...
	get panelClosingActions() {
		return (0, import_cjs.merge)(this.optionSelections, this.autocomplete._keyManager.tabOut.pipe((0, import_operators.filter)(() => this._overlayAttached)), this._closeKeyEventStream, this._getOutsideClickStream(), this._overlayRef ? this._overlayRef.detachments().pipe((0, import_operators.filter)(() => this._overlayAttached)) : (0, import_cjs.of)()).pipe((0, import_operators.map)((event) => event instanceof MatOptionSelectionChange ? event : null));
	}
	optionSelections = (0, import_cjs.defer)(() => {
	...
	_subscribeToClosingActions() {
		return (0, import_cjs.merge)(new import_cjs.Observable((subscriber) => {
			afterNextRender(() => {
				subscriber.next();
			}, { injector: this._environmentInjector });
		}), this.autocomplete.options?.changes.pipe((0, import_operators.tap)(() => this._positionStrategy.reapplyLastPosition()), (0, import_operators.delay)(0)) ?? (0, import_cjs.of)()).pipe((0, import_operators.switchMap)(() => this._zone.run(() => {
		...
		})), (0, import_operators.take)(1)).subscribe((event) => this._setValueAndClose(event));
	}
	_emitOpened() {
